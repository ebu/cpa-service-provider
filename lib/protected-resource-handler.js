...
module.exports = function(config, db, logger) {
  ...
  var checkIsAuthorized = function(accessToken, callback) {
    var requestOptions = {
      ...
      form: {
        token:               accessToken,
        service_provider_id: config.service_provider_name
      }
    };
  ...
  var doCreateUserAndClient = function(userId, clientId, callback) {
    if (userId) {
      db.User
  ...
  var createUserAndClient = function(userId, clientId, callback) {
    db.sequelize.transaction(function(transaction) {
      doCreateUserAndClient(userId, clientId, function(err, client, user) {
        if (err) {
